    ...
    public class TestGenerator : ITestGenerator
    {
        ...
        public SyntaxList<MemberDeclarationSyntax> GenerateMethods(IEnumerable<MethodInfo> declaration)
        {
            return SyntaxFactory.List<MemberDeclarationSyntax>(
                declaration.Select<MethodInfo, MemberDeclarationSyntax>(x => 
                    SyntaxFactory.MethodDeclaration(SyntaxFactory.PredefinedType(SyntaxFactory.Token(SyntaxKind.VoidKeyword)), SyntaxFactory.Identifier(x.Name + "Test"))
                    .WithAttributeLists(
                        SyntaxFactory.SingletonList<AttributeListSyntax>(
                            SyntaxFactory.AttributeList(
                                SyntaxFactory.SingletonSeparatedList<AttributeSyntax>(
